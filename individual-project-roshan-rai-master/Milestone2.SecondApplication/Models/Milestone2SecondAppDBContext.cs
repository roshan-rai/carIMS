...
public partial class Milestone2SecondAppDBContext : DbContext
{
    public Milestone2SecondAppDBContext()
    {
    }

    public Milestone2SecondAppDBContext(DbContextOptions<Milestone2SecondAppDBContext> options)
        : base(options)
    {
    }
